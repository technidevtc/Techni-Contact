...
//$pdf->image($image, $posi, 0,120);
        ...
        $MdCC  = utf8_decode("Modèles disponibles");
        $Mdc  = utf8_decode("Modèle disponible");
        ...
        if($pdt['nb_refs'] > 0){
		  ...
		  $libelle  = utf8_decode("Libellé");
		  $refTc  = utf8_decode("Réf. TC");
