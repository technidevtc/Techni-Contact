...
<div>
	...
	<div class="intro">
		<p>Bonjour,<br/>
		<br/>
		Un utilisateur du site <a href="{$constant['URL']}" target="_blank">Techni-Contact</a>
		vient de demander des informations sur le produit <b>{$data['MAINPRODUCT_NAME']}</b> de l'annonceur <b>{$data['MAINPRODUCT_ORIGINAL_ADVERTISER_NAME']}</b>.
		<br/>
		<br/>
        Utilisateur à l'origine du lead : {$data['ADMIN_ORIGIN_USER']}<br/>
        Source du lead : {$data['ADMIN_LEAD_SRC']}<br/>
        <br/>
		{$data['ADMIN_COMMERCIALRECAP']}
		</p>
	</div>
