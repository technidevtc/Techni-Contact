...
<div>
	...
	<div id="hook">
		...
		<p><br/></p>
		{$data['LINKEDPRODUCT_PRECISIONS']}
		
		<div class="titreBloc">Fiche du produit {$data['LINKEDPRODUCT_NAME']}</div>
		<div class="mail">
			<div class="haut"></div>
			<div class="ficheProduit">
				<img src="{$data['LINKEDPRODUCT_IMAGE']}" alt=""/>
				<div class="sousTitreBloc">Description :</div>
				<div class="contenuBloc">
					{$data['LINKEDPRODUCT_DESCRIPTION']}
				</div>
				{$data['LINKEDPRODUCT_DETAILEDDESCRIPTION']}
				<div class="sousTitreBloc">Prix / Références :</div>
				<div class="contenuBloc">
					{$data['LINKEDPRODUCT_PRICEDATA']}
				</div>
			</div>
			<div class="miseazero"></div>
			<div class="bas"></div>
