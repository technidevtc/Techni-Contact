...
$this->content .= <<< EOF
	<div class="mail_body">
		<p>Bonjour,</p>
		<p>
			Une demande d'inscription a été effectuée le {$data['InscriptionDate']} par l'adresse {$data['InscriptionIP']} :</p>
			<table cellspacing="0" cellpadding="0">
				...
				<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td>Catalogues sur lesquels l'annonceur souhaite voir apparaître ses produits :</td><td><b>{$data['CatalogueList']}</b></td></tr>
				<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
				<tr><td>Connaissait le catalogue papier Techni-Contact :</td><td><b>{$data['KnewCatalogue']}</b></td></tr>
				<tr><td>Souhaite recevoir le catalogue papier :</td><td><b>{$data['WantCatalogue']}</b></td></tr>
			</table>
		</p>
	</div>
EOF;
