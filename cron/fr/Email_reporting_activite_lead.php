		...
		//******************** Start building mails 
			...
			$message_text	.= '<img src="http://www.techni-contact.com/media/emailings/mails-serveur-tc/logo-tc.jpg">';
				...
				$message_text	.= '<p>';
					...
					$message_text	.= '<br />';
					$message_text	.= '&nbsp;Leads chat : <strong>'.$content_total_leads_primary_chat['c_id'].'</strong>';
					$message_text	.= '<br />';
					$message_text	.= '&nbsp;Leads click to call : <strong>'.$content_total_leads_primary_click_to_call['c_id'].'</strong>';
				$message_text	.= '</p>';
