...
define("CATALOG_FILE", WWW_PATH."media/auto/nextperformance/products-db.xml");
...
$fields_list = array (
	...
	"producturl" => array("source_type" => "UC", "default" => "__PRODUCT_URL__", "filter_type" => "url,urlext=?utm_source=banner-retarget-np&utm_medium=banner-retarget&utm_campaign=retarget-next-p&campaignID=02"),
				...
				case "UC" :
					switch($set["default"]) {
						...
						case "__PRODUCT_PRICE_P__" :				
																	...
																	$pdt[$field_name] = ($adv["as_estimate"] == 1 || !is_numeric($ref["price"]) || $adv["category"] != __ADV_CAT_SUPPLIER__ || $ref["pdt_as_estimate"] == 1) ? 0 : sprintf("%.02f",$ref["price"]); break;
