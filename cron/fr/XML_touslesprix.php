...
define("CATALOG_FILE", WWW_PATH."media/auto/touslesprix/TC_XML_touslesprix.xml");
...
$fields_list = array (
	"product_id" => array("source_type" => "UC", "default" => "__PRODUCT_ID__", "filter_type" => ""),
				...
				case "UC" :
					switch($set["default"]) {
						...
						case "__PRODUCT_URL__" :
							$pdt[$field_name] = URL . 'produits/' . $ref["idFamily"] . '-' . $ref["pdtID"] . '-' . $ref["ref_name"] . '.html?utm_source=tous-les-prix&utm_medium=comparateurs-prix&utm_campaign=tous-les-prix&campaignID=26';
							break;
