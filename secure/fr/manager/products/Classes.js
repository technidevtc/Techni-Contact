...
HN.PageSwitcher = function()
{
	...
	function PSclick (link)
	{
		if (link.num_page)
		{
			...
			that.Refresh();
			if (TriggerFct) TriggerFct(CurrentPage);
		}
	}
...
/********************************/
/** Class FamiliesSearchEngine **/
/********************************/

HN.FamiliesSearchEngine = function () {

  var win = null, bg = null, legend = null;
    ...
    if ((win = document.getElementById(id)))
      {
          ...
          if (bg) {
                  ...
                  bg = document.createElement('div'); bg.className = "familySE-window-bg";
          }
