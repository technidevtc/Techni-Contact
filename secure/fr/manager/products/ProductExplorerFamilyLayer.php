...
{
	makeRequest('FamiliesExplore.php?<?php echo $sid ?>' + params, 'ProcessFamilies');
	...
	try
	{
		if (response.readyState == 4)
		{
			if (response.status == 200)
			{
				...
				document.getElementById('performingRequestPEW').style.visibility = 'hidden';
			}
			else
			{
		...
		{
			document.getElementById('performingRequestPEW').style.visibility = 'visible';
		}
	}
	catch(e)
	{
