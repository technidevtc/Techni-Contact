...
/*================================================================/
 ...
 Fichier : /secure/manager/families/linkProduct.php
...
if(($result = & $handle->query('select name from products_fr where active = 1 and id = \'' . $handle->escape($_GET['id']). '\'', __FILE__, __LINE__)) && $handle->numrows($result, __FILE__, __LINE__) == 1)
{
