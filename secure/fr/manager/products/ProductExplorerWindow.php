...
//-->
	...
	<div id="ProductExplorerWindow">
		<div class="window_title_bar">
			<img class="wtb_close_img" src="../images/window_close.gif" onMouseDown="swap_cbtn(this,'down')" onMouseOut="swap_cbtn(this,'out')" onMouseUp="swap_cbtn(this,'up')" />			
			<div onmousedown="grab(document.getElementById('ProductExplorerWindow'), document.getElementById('ProductExplorerWindowShad'))">
				<img class="wtb_move_img" src="../images/window_move.gif" />
				<div class="wtb_text">Sélectionner un produit</div>
				<div class="zero"></div>
			</div>
		</div>
		<div id="performingRequestPEW">Chargement en cours...</div>
		<ul id="ProductExplorerTabs">
			<li id="ProductExplorerFamilyTab">family</li>
			<!--<li class="PETab" id="ProductExplorerSupplierTab">supplier</li>-->
			<li id="ProductExplorerSearchTab">search</li>
		</ul>
