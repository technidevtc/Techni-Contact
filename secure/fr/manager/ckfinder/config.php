...
//$baseUrl = '/userfiles/';
$baseUrl = 'http://www.techni-contact.com/ressources/images/tcarbo/';
...
ATTENTION: The trailing slash is required.
*/
// OD 27/5/2011 param serveur prod
$baseDir = '/data/technico/www/fr/ressources/images/tcarbo/';//resolveUrl($baseUrl);
