	...
	function ajaxLoadChartCommercial(startDate,endDate,typeG) {
		...
		$.getJSON('Ajax_sav/statsGraph/AJAX_statsCommercial.php', {			
			start:	startDate,
			end  :	endDate,
			type :  typeG
		}, function(data) {			
			...
			var chart 		= new xChart('bar', local_data, '#chartCommercial' , opts);
			chart._resize();			
		});
	}	