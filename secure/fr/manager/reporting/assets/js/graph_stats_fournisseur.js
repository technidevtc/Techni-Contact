	...
	function ajaxLoadChartFournisseur(startDate,endDate,typeG) {
		...
		$.getJSON('Ajax_sav/statsGraph/AJAX_statsFournisseur.php', {			
			start:	startDate,
			end  :	endDate,
			type :  typeG
		}, function(data) {			
			...
			var chart 		= new xChart('bar', local_data, '#chartFournisseur' , opts);
			chart._resize();			
		});
	}	