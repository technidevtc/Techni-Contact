	...
	function ajaxLoadChartSource(startDate,endDate,typeG) {
		...
		$.getJSON('Ajax_sav/statsGraph/AJAX_statsSource.php', {			
			start:	startDate,
			end  :	endDate,
			type :  typeG
		}, function(data) {			
			...
			var chart 		= new xChart('bar', local_data, '#chartSource' , opts);
			chart._resize();			
		});
	}	