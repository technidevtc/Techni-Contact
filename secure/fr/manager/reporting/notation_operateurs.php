...
if ((!$userChildScript->get_permissions()->has("m-reporting--sm-notation-operateurs","r")) && (!$userChildScript->get_permissions()->has("m-reporting--sm-notation-operateurs","r")) ) {
...
<div id="notation_operateurs"></div>
...
function send_repporting(){
	...
	if(check_interval == '0'){
		...
		$.ajax({
				url: 'AJAX_table_notation_operateurs.php?date_start='+date_start+'&date_end='+date_end+'&views_date_interval='+check_interval+'&views_date_not_in_visible='+views_date_not_in_visible,
				type: 'GET',
