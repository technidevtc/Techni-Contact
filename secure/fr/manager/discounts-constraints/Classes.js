...
/********************************/
/** Class Multiple ElementList **/
/********************************/

function MultipleElementList (id, ElementType, _ilo)
{
	this.id = id;
	this.ElementType = ElementType;
...
MultipleElementList.prototype.Add = function (ElementID, ElementText, ElementImg)
{
...
MultipleElementList.prototype.Delete = function (Elements)
{
...
MultipleElementList.prototype.Clear = function () {
...
MultipleElementList.prototype.Clean = function () {
	for (var o in this.ec) document.getElementById(this.id).removeChild(this.ec[o]);
}

MultipleElementList.prototype.Draw = function () {
