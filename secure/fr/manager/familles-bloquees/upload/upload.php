...
if (file_exists("/data/technico-test/www/fr/ressources/images/tcarbo/". $_FILES["upload"]["name"])){
 echo $_FILES["upload"]["name"] . " already exists please choose another image.";
}else{
 move_uploaded_file($_FILES["upload"]["tmp_name"],
 "/data/technico-test/www/fr/ressources/images/tcarbo/" . $_FILES["upload"]["name"]);
