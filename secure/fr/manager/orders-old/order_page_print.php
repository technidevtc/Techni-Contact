...
/*================================================================/
 ...
 Fichier : /secure/fr/manager//order_page_print.html
 Description : aperçu bon commande
...
$title = 'Aperçu du bon de commande n°'.$_GET['idOrder'];
...
unitaire HT
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align : center"><?php echo sprintf("%0.2f", $item['price2']) ?> &euro;</td>
          <td style="text-align : center"><?php echo sprintf("%0.2f", $item['price2']*$item['quantity']) ?> &euro;</td>
        </tr>
        <?php
    ...
    <table class="bill_total">
      <tbody>
        <tr>
          ...
          <td style="width : 50%"><strong><?php echo sprintf("%0.2f", $order->totalOrdreHT-$fdp_ordre) ?> &euro;</strong></td>
        </tr>
        <tr>
          <td style="width : 50%">Frais en sus</td>
          <td style="width : 50%"><strong><?php echo sprintf("%0.2f", $fdp_ordre) ?> &euro;</strong></td>
        </tr>
        <tr>
          <td style="width : 50%">Total HT</td>
          <td style="width : 50%"><strong><?php echo sprintf("%0.2f", $order->totalOrdreHT) ?> &euro;</strong></td>
        </tr>
        <tr>
          <td style="width : 50%">Montant TVA</td>
          <td style="width : 50%"><strong><?php echo sprintf("%0.2f", $Price2TTC+$fdp_ordre_TVA) ?> &euro;</strong></td>
        </tr>
        <tr>
          <td style="width : 50%">Total TTC</td>
          <td style="width : 50%"><strong><?php echo sprintf("%0.2f", $order->totalOrdreTTC) ?> &euro;</strong></td>
        </tr>
      </tbody>
    </table>
    <div class="zero"></div>
