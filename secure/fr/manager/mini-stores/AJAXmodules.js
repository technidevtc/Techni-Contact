			...
			for (k1 in cat1) {
				...
				a.Select = function () { // lors de la sélection
					...
					for (k2 in cat2) {
						...
						a2.Select = function () {
							/* former behavior, no selectionnable cat2
                                                         * 
							...
							this.className = 'currentUnfolded';*/
                                                        ...
                                                        // allows cat2 selection
                                                        family.id = this.family_id;
                                                        family.name = cat2[this.index].name;
                                                        family.ref_name = cat2[this.index].ref_name;
                                                        if (this.parentNode.current_sf && this.parentNode.current_sf != this) this.parentNode.current_sf.className = '';
                                                        this.parentNode.current_sf = this;
                                                        this.className = 'currentUnfolded';

                                                        desc.innerHTML = "Famille " + cat2[this.index].name;
                                                        // allows cat2 selection
