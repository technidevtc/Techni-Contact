...
//var locationparamtemp = "/#.*/";
 
 /*
	
 (function($,e,b){var c="hashchange",h=document,f,g=$.event.special,i=h.documentMode,d="on"+c in e&&(i===b||i>7);function a(j){j=j||location.href;return"#"+j.replace(/^[^#]*#?(.*)$/,"$1")}$.fn[c]=function(j){return j?this.bind(c,j):this.trigger(c)};$.fn[c].delay=50;g[c]=$.extend(g[c],{setup:function(){if(d){return false}$(f.start)},teardown:function(){if(d){return false}$(f.stop)}});f=(function(){var j={},p,m=a(),k=function(q){return q},l=k,o=k;j.start=function(){p||n()};j.stop=function(){p&&clearTimeout(p);p=b};function n(){var r=a(),q=o(m);if(r!==m){l(m=r,q);$(e).trigger(c)}else{if(q!==m){location.href=location.href.replace(locationparamtemp,"")+q}}p=setTimeout(n,$.fn[c].delay)}$.browser.msie&&!d&&(function(){var q,r;j.start=function(){if(!q){r=$.fn[c].src;r=r&&r+a();q=$('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){r||l(a());n()}).attr("src",r||"javascript:0").insertAfter("body")[0].contentWindow;h.onpropertychange=function(){try{if(event.propertyName==="title"){q.document.title=h.title}}catch(s){}}}};j.stop=k;o=function(){return a(q.location.href)};l=function(v,s){var u=q.document,t=$.fn[c].domain;if(v!==s){u.title=h.title;u.open();t&&u.write('<script>document.domain="'+t+'"<\/script>');u.close();q.location.hash=v}}})();return j})()})(jQuery,this);
...
HN.TC.AjaxQuery.prototype = (function(){
  ...
  o.execute = function(cb){
    ...
    $.ajax({
      type: "POST",
      url: HN.TC.EXTRANET_URL+"ressourcesv3/extranet_v3_ajax/AJAX_Doctrine_Interface.php",
...
HN.TC.AjaxDoctrineObject.prototype = {
  ...
  execute: function(cb){
    ...
    $.ajax({
      type: "POST",
      url: HN.TC.ADMIN_URL+"ressourcesv3/extranet_v3_ajax/AJAX_Doctrine_Interface.php",
...
HN.TC.ajaxUploadFile = function(o){
  ...
  me.doAjaxFileUpload = function(){
    ...
    $.ajaxFileUpload({
      url: HN.TC.EXTRANET_URL+"ressourcesv3/extranet_v3_ajax/AJAX_files_upload.php",
      secureuri: false,
...
HN.TC.getUploadedFiles = function(o){
  ...
  me.getUploadedFilesList = function(){
    ...
    $.ajax({
      url: HN.TC.EXTRANET_URL+"ressourcesv3/extranet_v3_ajax/AJAX_get_uploaded_files_list.php",
      secureuri: false,
      type: 'post',
      dataType: 'json',
      data: {
...
HN.TC.deleteUploadedFile = function(fileId){
  ...
  me.deleteFileFunction = function(){
    ...
    $.ajax({
      url: HN.TC.EXTRANET_URL+"ressourcesv3/extranet_v3_ajax/AJAX_delete_uploaded_file.php",
      secureuri: false,
      type: 'post',
      dataType: 'json',
      data: {
