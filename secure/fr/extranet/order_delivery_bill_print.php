...
/*================================================================/
 ...
 Fichier : /secure/extranet/order_delivery_bill_print.html
...
<title><?php echo 'BL-'.$_GET['idOrder'] ?></title>
...
<br />
  ...
  <a href="http://www.techni-contact.com">http://www.techni-contact.com</a>
          ...
          <td style="text-align: right;">
            <strong><?php echo $ste ?></strong><br />
            <?php echo $nomPrenom ?><br />
            <?php echo $adresse ?><br />
            <?php echo $cpLoca ?><br />
            <?php echo $pays ?><br />
            <?php echo $tel ?><br />
            <strong>N° de commande : <?php echo $order->idCommande ?></strong>
          </td>
        </tr>
        </tbody>
    </table>
