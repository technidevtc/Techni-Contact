<?php
	...
	$stats_category_id		= mysql_escape_string($_POST['stats_category_hidden_id']);
	...
	if(!empty($_SESSION['extranet_user_id'])){
		...
		if(strcmp($type,'simple')==0 || ($stats_interval_v1==$stats_interval_v2)){
			...
			require_once('extranet_v3_stats_load_category_detail_external_file.php');
