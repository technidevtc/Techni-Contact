<div class="za">
	<div id="page-heading" class="ng-scope">
		<h1 class="campaigns_h1_left"><i class="fa fa-server"></i> Statistiques de campagnes</h1>
		...
		<div class="col-md-12" style="width:100%;">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div id="loader_table">
						<img id="img-upload" src="<?php echo MARKETING_URL.'ressources/images/lightbox-ico-loading.gif'; ?>" />
					</div>
