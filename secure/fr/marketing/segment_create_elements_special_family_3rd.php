<?php
	...
	if(strcmp($local_field_operation_A,"1")==0){
		$local_query_where .=" \n ( ".$data_get_field_info['name_sql']."=".$local_field_value1_A." ) \n";
	}else if(strcmp($local_field_operation_A,"AND")==0){
		$local_query_where .=" \n AND ( ".$data_get_field_info['name_sql']."=".$local_field_value1_A." ) \n";
	}else if(strcmp($local_field_operation_A,"OR")==0){
		$local_query_where .=" \n OR ( ".$data_get_field_info['name_sql']."=".$local_field_value1_A." ) \n";
	}
