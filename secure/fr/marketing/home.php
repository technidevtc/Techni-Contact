...
<head>
  ...
  <title>Marketing Techni-contact.com</title>
  <meta name="description" content="Techni-contact.com Marketing">
  
  <?php require_once('header_tags.php'); ?>
    <script type="text/javascript" src="ressources/js/home.js"></script>
  
</head>
<body ng-app="ZTechnicoAppMarketing">
	<div id="container_global"><? // class="container_global_home" ?>
		...
		<div id="container_middle_global">
			...
			<div id="content_middle_global">
				<div id="content_middle">
					<?php require_once('home_center.php'); ?>
				</div>
