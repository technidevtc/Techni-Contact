...
<head>
	<meta charset="UTF-8">
	<title>Modifier un segment - Techni-contact.com</title>
	...
	<script type="text/javascript" src="ressources/js/segments_edit.js"></script>
	<script type="text/javascript">
		$( document ).ready(function() {
			
			//Load the segment fields 
			segment_edit_load_the_fields();			
		});
	</script>
</head>
		...
		<div id="container_middle_global">
			...
			<div id="content_middle_global">
				<div id="content_middle">
					<?php require_once('segments_edit_center.php'); ?>
				</div>
