...
class RefAttributeVirtualProductsCollection extends BaseCollection {

  protected $childObjectName = "RefAttributeVirtualProducts";
  protected $keyName = "id_ref_attribute_virtual";
