...
class Command2
{
	...
	*/
	...
	function Command2(& $handle, $id = NULL, $init = '', $stats = true)
	{
		$this->handle = & $handle;
		$this->stats = $stats;
		if ($id != NULL)
	...
	function save()
	{
		...
		$listpdt = array();
		$listpdt[] = array('idProduct', 'idTC', 'name', 'fastdesc', 'label', 'price', 'price2', 'unite', 'quantity', 'tauxTVA', 'tauxRemise', 'idAdvertiser', 'refSupplier');
